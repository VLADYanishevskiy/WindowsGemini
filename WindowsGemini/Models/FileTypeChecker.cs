...
namespace WindowsGemini.Models
{
    class FileTypeChecker
    {
        ...
        private static List<string> arciveExtensions = new List<string>() { ".a",".ar",".cpio",".shar",".LBR",".iso",".lbr",".mar",".sbx",".tar",".bz2",".F",".?XF",".gz",".lz",".lz4",".lzma",".lzo",".rz",".sfark",".sz",".?Q?",".?Z?",".xz",".z",".Z",".zst",".??_",".7z",".s7z",".ace",".afa",".alz",".apk",".arc",".ark",".cdx",".arj",".b1",".b6z",".ba",".bh",".cab",".car",".cfs",".cpt",".dar",".dd",".dgc",".dmg",".ear",".ha",".hki",".ice",".jar",".kgb",".lzh",".lzx",".pak",".partimg",".paq6",".pea",".pim",".pit",".qda",".rar",".rk",".sda",".sea",".sen",".sfx",".shk",".sit",".sitx",".sqx",".tar.gz",".uc",".uca",".war",".wim",".xar",".zoo",".zz",".ecc",".par",".rev"};
